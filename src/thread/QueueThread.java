 ...
 * 才能继续执行。一个对象锁是prev，就是前一个线程所持有的对象锁。
 ...
 * 程序运行的主要过程就是A线程最先运行，持有C,A对象锁，后释放A,C锁，唤醒B。线程B等待A锁，
...
public class QueueThread implements Runnable{
	...
	public QueueThread(String name, Object prev, Object self) {
		this.name = name;
		this.prev = prev;
		this.self = self;
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		QueueThread qa = new QueueThread("A", c, a);
		QueueThread qb = new QueueThread("B", a, b);
		QueueThread qc = new QueueThread("C", b, c);
